package com.fortytwotalents.spring.cloud.workshop.frontend.controller;
...
import com.fortytwotalents.spring.cloud.workshop.frontend.client.FeignEventClient;
import com.fortytwotalents.spring.cloud.workshop.frontend.client.RestTemplateEventClient;
...
public class FrontendController {
	...
	@Autowired
	private RestTemplateEventClient restClient;

	@Autowired
	private FeignEventClient feignClient;
